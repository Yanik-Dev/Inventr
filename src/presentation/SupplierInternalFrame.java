 ...
 * @author Yanik
 */
public class SupplierInternalFrame extends javax.swing.JInternalFrame {
    ...
    public void init(){
        ((DefaultTableModel) this.tableSuppliers.getModel()).setNumRows(0);
    ...
    public void search(String search){
        this._dbService = new SupplierService();
        ((DefaultTableModel) this.tableSuppliers.getModel()).setRowCount(0);
        DefaultTableModel model = (DefaultTableModel) this.tableSuppliers.getModel();
        model.setRowCount(0);
        this.suppliers = this._dbService.search(search);
    ...
    private void initComponents() {
        ...
        textAreaRecent = new javax.swing.JTextArea();
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtboxSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 1007, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        textAreaRecent.setColumns(20);
        textAreaRecent.setFont(new java.awt.Font("Segoe UI Light", 0, 16)); // NOI18N
        textAreaRecent.setRows(5);
        jScrollPane4.setViewportView(textAreaRecent);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(683, 683, 683))
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 1358, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditActionPerformed
        ...
        Supplier supplierToEdit = this.suppliers.get(row);
    ...
    private void tableSuppliersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableSuppliersMouseClicked
        ...
        Supplier supplier = this.suppliers.get(row);
        String numberString = "";
        String emailString = "";
    ...
    private javax.swing.JTextArea textAreaRecent;
